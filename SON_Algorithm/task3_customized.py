...
def arg_parse():
	...
	parser.add_argument('--output_file', type=str,default='./data/a1t3_customized.json',help='the output contains your answers')
	parser.add_argument('--n_partitions', type=int,default=16,help='n partitions')
	parser.add_argument('--n', type=int,default=200,help='review counts larger than n')
...
if __name__ == "__main__":
	...
	repartitioned = review_data.repartition(args.n_partitions,"review_id")
	task = task3(repartitioned.rdd, args)
	task.review_n_count()